...
async def update_journal_entry(entry_id: str, note: str = None, classification: str = None, shared: bool = None) -> None:
    ...
    await database["Journals"].update_one({"entry_id": entry_id}, {"$set": update_fields})
